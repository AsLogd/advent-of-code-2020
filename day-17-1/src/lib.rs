...
fn is_alive_next_turn(g: &Grid, coords: &(i32, i32, i32)) -> bool {
    let mut sum = 0;
        ...
        for x in coords.0-1..coords.0+2 {
            for y in coords.1-1..coords.1+2 {
                for z in coords.2-1..coords.2+2 {
                    ...
                    *cell = is_alive_next_turn(&g, &(x,y,z));
                }
            }
        }
    }
